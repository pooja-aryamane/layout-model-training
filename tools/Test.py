...
if __name__ == "__main__":
    ...
    parser.add_argument("-json-annotation-test", type = str, metavar="FILE", help="The path to the test set JSON annotation")
    parser.add_argument("-image-path-test", type = str, metavar="FILE", help="The path to the test set image folder")
