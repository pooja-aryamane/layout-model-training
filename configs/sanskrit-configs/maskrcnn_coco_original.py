# -*- coding: utf-8 -*-
"""mask_RCNN_finetuned_COCO_config.ipynb
...
cfg.MODEL.WEIGHTS = model_zoo.get_checkpoint_url("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml")  # faster-RCNN using COCO weights
...
cfg.OUTPUT_DIR= "maskrcnn_coco_original_output"
